<template>
  <div class="HomePage-box">
    <div class="title-box">
      <div class="tltl1">Your favorite genre</div>
      <a href="#" @click="tz">
        <div class="tltl2">change</div>
      </a>
...
export default {
  ...
  methods: {
    ...
    async init() {
      const res = await this.$afuntion.httsGet("/api/ratings/getXh?currentPage=" + this.currentPage + "&pageSize=" + this.pageSize);
