<template>
  <div class="Box">
    <div class="category">
      <div class="centero"><span>My ratings</span></div>
    </div>
    <div class="content">
            ...
            <div class="box_white">
              <div>
                ...
                <div style="float: right;margin-left: 50px">
                  <el-button type="danger" @click="deletM(item)">Delete</el-button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    async deletM(v) {
      ...
      const  res = await this.$afuntion.httsGet("/api/ratings/deletM?id="+v.id);
      this.init()
    },
    async starf() {
    ...
    async init() {
      ...
      const  res= await this.$afuntion.httsPost("/api/ratings/like", {
        name: tokenStr,
      });
